        ...
        <div className="about" id="about">
            ...
            <div className="about-container">
                ...
                <div className="bio">
                    ...
                    <p className="bio-text">If my dog were to describe me, he probably would start off by going on a tangent by trying to convince you to tell me to make an illustration of him like I did for the cats above.</p>
                    <p></p>
