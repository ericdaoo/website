    ...
    return (
        <div className="overlay">
            ...
            <div className="overlay-container">
                ...
                <p className="overlay-text">
                    In this research, quantifiable evidence was paired with empathetic storytelling to convey meaning to complex data related to income distribution. In the end, the evidence gathered appears to reveal that based on several different metrics, NYC possesses a significantly higher level of income disparity than Taipei. To supplement this quantifiable data, the use of more-subjective tools/information, such as color schemes, photographs, figures, and first-hand accounts were utilized to provide additional context.
                </p>
                <p className="overlay-text">
                    My overall hope is that this project will provide an alternate perspective to those who have accepted the belief that every large urban city in the world possesses extreme large income inequality; or to those who aren’t aware of the unfathomably large income inequalities that exist in other developed country’s cities.
                </p>
